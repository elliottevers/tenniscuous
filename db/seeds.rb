...
ActiveRecord::Base.transaction do
  professional_players = [{
    ...
    username: "Fabio",
    profile_picture_url: "http://res.cloudinary.com/dax4cembx/image/upload/v1447898564/fabio-fognini-in-azione_yiq2o0.jpg",
    password_digest: BCrypt::Password.create("Fabio Fognini"),
    session_token: SecureRandom.urlsafe_base64(16),
    profile_description: "",
    gender: "Male",
    genders_sought: ["Men's Singles","Mixed Doubles"],
  ...
  ceo = {
    ...
    password_digest: BCrypt::Password.create("Elliott"),
    session_token: SecureRandom.urlsafe_base64(16),
    profile_description: "Hey! I'm the founder of Tenniscuous.  I live in Silicon Valley but would love to hit with you whenever you stop by.",
    gender: "Male",
    genders_sought: ["Men's Singles","Men's Doubles","Mixed Doubles"],
    rating: 4.0,
    ratings_sought: [1.0,7.0],
    position: [46.344215,-112.89743],
    discovery_radius: 50,
    accepted_users: [],
    seen_users: []
  }
